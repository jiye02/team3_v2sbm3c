...
<title>http://localhost:9093/recommend/mf_gallery.do</title> 
...
function send() {
  ...
  $.ajax({
    url: 'http://127.0.0.1:8000/recommend_movie/mf_movie', // form action
    ...
    success: function(rdata) { // 응답이 온경우
      ...
      for (var i=0; i< rdata.length; i++) {  // 0 ~ 2
        ...
        tags += "movie_id: " + row.movie_id + "<br>";
        tags += "movie_title: " + row.movie_title +"<br>";
        tags += "movie_rating: " + row.movie_rating + "</li>";
        tags += "</DIV>";
      }
      tags += "</DIV>";
  ...
  $('#panel').html("<img src='/recommend_movie/images/ani04.gif' style='width: 10%;'>"); // static
...
<DIV style='width: 80%; margin: 0px auto;'> 
  <FORM name='frm' id='frm' style='width: 80%; margin: 0px auto;'>
    <TABLE class='table' style='width: 80%; margin: 0px auto;'>
      <TR>
        <TH>회원 번호</TH>
        <TD><input type='number' name='userId' id='userId' size='10' value='1' class='form-control'></TD>
      </TR>
    </TABLE>
