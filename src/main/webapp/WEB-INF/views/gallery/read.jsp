...
<DIV class='title_line'><A href="./list_by_exhino.do?exhino=${exhino }" class='title_link'>${exhiVO.name }</A></DIV>
...
<DIV class='content_body'>
  <ASIDE class="aside_right">
    ...
    <c:if test="${sessionScope.admin_id != null }">
      ...
      <A href="./update_text.do?galleryno=${galleryno}&now_page=${param.now_page}&word=${param.word }">글 수정</A>
      <span class='menu_divide' >│</span>
      <A href="./update_file.do?galleryno=${galleryno}&now_page=${param.now_page}">파일 수정</A>  
      <span class='menu_divide' >│</span>
      <A href="./map.do?exhino=${exhino }&galleryno=${galleryno}">지도</A>
      <span class='menu_divide' >│</span>
      <A href="./youtube.do?exhino=${exhino }&galleryno=${galleryno}">Youtube</A>
      <span class='menu_divide' >│</span>
    ...
    <span class='menu_divide' >│</span>    
    <A href="./list_by_exhino.do?exhino=${exhino }&now_page=${param.now_page}&word=${param.word }">기본 목록형</A>    
    <span class='menu_divide' >│</span>
    <A href="./list_by_exhino_grid.do?exhino=${exhino }&now_page=${param.now_page}&word=${param.word }">갤러리형</A>
  </ASIDE> 
