...
<c:set var="exhino" value="${param.exhino }" /> <%-- mav.addObject("exhino", galleryVO.getExhino()); // redirect parameter 적용 --%>
  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='./create.do?exhino=${exhino}'" class="btn btn-info btn-sm">새로운 컨텐츠 등록</button>
        <button type='button' onclick="location.href='./list_by_exhino.do?exhino=${exhino}'" class="btn btn-info btn-sm">목록</button>
        <button type='button' onclick="location.href='./list_by_exhino_grid.do?exhino=${exhino}'" class="btn btn-info btn-sm">갤러리 목록</button>
      </LI>
    </UL>
  </fieldset>
