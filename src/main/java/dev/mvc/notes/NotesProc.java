...
@Component("dev.mvc.notes.NotesProc")
  public class NotesProc implements NotesProcInter {
    ...
    public ArrayList<NotesVO> list_by_search(NotesVO notesVO) {
      ArrayList<NotesVO> list = this.notesDAO.list_by_search(notesVO);
      return list;
    }
    ...
    public ArrayList<NotesVO> list_by_search_paging(NotesVO notesVO) {
      ...
      */
      ...
      ArrayList<NotesVO> list = this.notesDAO.list_by_search_paging(notesVO);
      ...
      public String pagingBox(int now_page, String word, String list_file){ 
        ...
        int search_count = this.notesDAO.search_count(notesVO);  //검색된 레코드 수 -> 전체 페이지 규모 파악
...
//        str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
    ...
    public int password_check(NotesVO notesVO) {
      int cnt = this.notesDAO.password_check(notesVO);
      return cnt;
    }
    ...
    public int cnt_add(int notesno) {
      int cnt = this.notesDAO.cnt_add(notesno);
      return cnt;
    }
