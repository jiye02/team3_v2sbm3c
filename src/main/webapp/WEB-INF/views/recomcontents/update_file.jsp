...
<c:set var="thumb1" value="${recomcontentsVO.thumb1.toLowerCase() }" />
...
<DIV class='title_line'><A href="./list_by_recno_search_paging.do?recno=${recno }" class='title_link'>${recomplaceVO.recname }</A> > 파일 수정</DIV>
...
<DIV class='content_body'>
  <ASIDE class="aside_right">
    ...
    <span class='menu_divide' >│</span>
    <A href="./list_by_recno.do?recno=${recno }">기본 목록형</A>    
    <span class='menu_divide' >│</span>
      ...
      <li class="li_none">
        <DIV style='text-align: center; width: 50%; float: left;'>
          <c:choose>
            ...
            <c:otherwise> <!-- 이미지가 없음 -->
               <IMG src="/recomcontents/images/none1.png" style="width: 90%;"> 
            </c:otherwise>
          </c:choose>
