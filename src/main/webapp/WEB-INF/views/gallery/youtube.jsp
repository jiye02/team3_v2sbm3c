...
<DIV class='title_line'><A href="/gallery/list_by_exhino.do?exhino=${exhiVO.exhino }" class="title_link">${exhiVO.name }</A> > ${galleryVO.title } > Youtube 등록/수정/삭제</DIV>
...
<DIV class='content_body'>
  ...
  <FORM name='frm_youtube' method='POST' action='./youtube.do'>
    ...
    <div>
       ...
       <textarea name='youtube' class="form-control" rows="12" style='width: 100%;'>${galleryVO.youtube }</textarea>
    </div>
  ...
  <DIV style="text-align: center;">
      ...
      <IMG src='/gallery/images/youtube01.jpg' style='width: 60%;'><br><br>
      <IMG src='/gallery/images/youtube02.jpg' style='width: 60%;'><br>
  </DIV>
