...
<DIV class='content_body'>
  ...
  <div style='width: 100%;'> <%-- 갤러리 Layout 시작 --%>
    <c:forEach var="recomcontentsVO" items="${list }" varStatus="status">
      <c:set var="title" value="${recomcontentsVO.title.trim() }" />
      <c:set var="content" value="${recomcontentsVO.content.trim() }" />
      ...
      <div onclick="location.href='./read.do?recontno=${recontno }&word=${param.word }&now_page=${param.now_page == null ? 1 : param.now_page }'" class='hover'  
        ...
        <c:choose> 
          ...
          <c:otherwise> <!-- 이미지가 없는 경우 기본 이미지 출력: /static/contents/images/none1.png -->
            <IMG src="/recomcontents/images/none1.png" style="width: 100%; height: 140px;">
          </c:otherwise>
        </c:choose>
