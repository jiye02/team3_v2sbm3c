...
<c:set var="thumb1" value="${galleryVO.thumb1.toLowerCase() }" />
...
<DIV class='title_line'><A href="./list_by_exhino_search_paging.do?exhino=${exhino }" class='title_link'>${exhiVO.name }</A> > 파일 수정</DIV>
