...
<DIV class='title_line'><A href="/gallery/list_by_exhino.do?exhino=${exhiVO.exhino }" class="title_link">${exhiVO.name }</A> > ${galleryVO.title } > 지도 등록/수정/삭제</DIV>
...
<DIV class='content_body'>
  ...
  <FORM name='frm_map' method='POST' action='./map.do'>
    ...
    <div>
       <label>지도 스크립트</label>
       <textarea name='map' class="form-control" rows="12" style='width: 100%;'>${galleryVO.map }</textarea>
    </div>
  ...
  <DIV style="text-align: center;">
      ...
      <IMG src='/gallery/images/map01.jpg' style='width: 60%;'><br><br>
      <IMG src='/gallery/images/map02.jpg' style='width: 60%;'><br><br>
      <IMG src='/gallery/images/map03.jpg' style='width: 60%;'><br><br>
      <IMG src='/gallery/images/map04.jpg' style='width: 60%;'><br><br>
      <IMG src='/gallery/images/map05.jpg' style='width: 60%;'><br>
  </DIV>
