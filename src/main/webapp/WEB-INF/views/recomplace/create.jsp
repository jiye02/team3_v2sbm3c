...
<DIV class='content_body'>
  <!-- <FORM name='frm' method='POST' action='http://localhost:9093/exhi/create.do'> -->
  <!-- <FORM name='frm' method='POST' action='/exhi/create.do'> -->
  <FORM name='frm' method='POST' action='./create.do'> <!-- /exhi 폴더 자동 인식, 권장 -->
    <div>
       <label>카테고리 이름</label>
       <input type='text' name='recname' value='' required="required" 
