...
<DIV class='content_body'>
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_create' id='frm_create' method='POST' action='./create.do'>
      <label>카테고리 이름</label>
      <input type='text' name='recname' value='' required="required" style='width: 25%;' autofocus="autofocus">
  ...
  <TABLE class='table table-hover'>
    ...
    <c:forEach var="recomplaceVO" items="${list }">
      ...
      <TR>
        ...
        <TD class="td_bs_left"><A href="/recomcontents/list_by_recno_search_paging.do?recno=${recno }">${recname }</A></TD>
        <TD class="td_bs">${cnt }</TD>
        <TD class="td_bs">${rdate}</TD>
        <TD class="td_bs">${udate }</TD>
        <TD class="td_bs">
          <A href="../recomcontents/create.do?recno=${recno}" title="등록"><IMG src="/recomplace/images/create.png" class="icon"></A>
