...
<DIV class='title_line'> ${recomplaceVO.recname } > ${title } > 수정</DIV>
...
<DIV class='content_body'>
  ...
  <FORM name='frm' method='POST' action='./update_text.do'>
    ...
    <div class="content_body_bottom">
      ...
      <button type="button" onclick="location.href='./read.do?recno=${param.recno}&recontno=${recontno }'" class="btn btn-primary">취소</button>
    </div>
